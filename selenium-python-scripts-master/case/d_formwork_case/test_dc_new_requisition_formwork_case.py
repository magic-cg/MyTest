...
class NewRequisitionFormWorkCase(unittest.TestCase):
    ...
    def test_new_requisition_formwork(self):
        ...
        # 新建申请单模板
        new_requisition_fw.new_requisition_formwork(self.driver, gv.requisition_model_name1)
        # 设置申请单的审批流
        ...
        # 验证申请单模板是否已新建成功
        expense_name = get_form.get_formwork_name(self.driver, gv.requisition_model_name1)
        assertion.except_equal(gv.requisition_model_name1, expense_name, u'申请单模板未创建成功', u'新建申请单模板成功')