...
class NewExpFormWorkCase(unittest.TestCase):
    ...
    def test_new_exp_formwork(self):
        ...
        # 设置报销单的基本设置
        new_expense_fw.new_exp_formwork(self.driver, gv.exp_model_name2)
        # 设置审批流
        new_expense_fw.exp_flow1(self.driver)
        # 添加其他项
        ...
        # 验证报销单模板是否已新建成功
        expense_name = get_form.get_formwork_name(self.driver, gv.exp_model_name2)
        assertion.except_equal(gv.exp_model_name2, expense_name, u'报销单模板未创建成功', u'新建报销单模板成功')
