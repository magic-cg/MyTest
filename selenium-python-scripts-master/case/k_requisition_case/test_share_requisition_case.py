...
class TestInitiateExpense(unittest.TestCase):
    ...
    def test_share_requisition(self):
        ...
        # 选择模板，填写申请单标题
        new_requisition.select_model(self.driver, gv.requisition_title, gv.requisition_model_name3)
        # 添加申请明细
        ...
        sleep(2)
        # 申请事项共享
        initiate_ex.share_requistion(self.driver)
        # 验证是否出现提交成功的吐丝
        message = operation.message_reminder(self.driver)
        assertion.except_equal(u'共享成功', message, u'提交失败，可能进入到了提交中状态', u'共享成功')
